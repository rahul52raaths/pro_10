...
export class MarksheetmeritListComponent extends BaseCtl {
  constructor(public locator: ServiceLocatorService, public httpClient: HttpClient, public route: ActivatedRoute, private httpservice: HttpServiceService) {
  ...
  getJasper() {
    ...
    this.httpClient.get("http://localhost:8080/Jasper/report").subscribe((data) => {
      console.log(data);
    }, error => {
